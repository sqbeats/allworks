...
namespace vodka
{
    public partial class formAdm : Form
    {
        ...
        private void DisableButton()
        {
            if (currentBtn != null)
            {
                currentBtn.BackColor = Color.FromArgb(200, 65, 82);
        ...
        {
            ActiveButton(sender, Color.FromArgb(200, 65, 82));
        ...
        private void iconShopCart_Click(object sender, EventArgs e)
        {
            ...
            lblTitleChildForm.Text = "Пользователи";
        }
        ...
        {
            ActiveButton(sender, Color.FromArgb(148, 64, 213));
